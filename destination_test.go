...
func TestDestinationListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Destinations.List(context.TODO(), oursprivacy.DestinationListParams{
		Cursor: oursprivacy.String("cursor"),
		Limit:  oursprivacy.Int(25),
		Status: oursprivacy.DestinationListParamsStatusDisabled,
		Type:   oursprivacy.DestinationListParamsTypeAwsEventBridge,
	})
	if err != nil {
...
func TestDestinationNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Destinations.New(context.TODO(), oursprivacy.DestinationNewParams{
		Type:     oursprivacy.DestinationNewParamsTypeAudiohook,
...
func TestDestinationTypes(t *testing.T) {
	...
	_, err := client.Destinations.Types(context.TODO())
	if err != nil {
		var apierr *oursprivacy.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestDestinationHealth(t *testing.T) {
	...
	_, err := client.Destinations.Health(context.TODO(), "id")
	if err != nil {
		var apierr *oursprivacy.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
